...
import { GalleryBlock } from "@repo/ui/organisms";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const page = await getCollectionItem({ collection: 'pages', slug: 'gallery', config: resolvedConfig }) as Page;
...
export default async function Gallery() {
  const resolvedConfig = await config as Config;
  const pageData = await getCollectionItem({ collection: 'pages', slug: 'gallery', config: resolvedConfig }) as Page;
