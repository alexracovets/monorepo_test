...
import { generateMeta, getCollectionItem, getNews } from "@repo/ui/utils";
import { AtomText, Container } from "@repo/ui/atoms";
import { NewsBlock } from "@repo/ui/organisms";
...
export default async function News() {
  const resolvedConfig = await config as Config;
  const pageData = await getCollectionItem({ collection: 'pages', slug: 'news', config: resolvedConfig }) as Page;
